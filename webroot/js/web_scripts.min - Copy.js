                        ...
                        (t = {
                            ...
                            for (var s in this.waypoints[o]) {
                                ...
                                p.element !== p.element.window && (h = p.adapter.offset()[r.offsetProp]),
                                    ...
                                    (d = !l && !_),
                                    !v && l && _ ? (p.queueTrigger(r.backward), (i[p.group.id] = p.group)) : ((!v && d) || (v && r.oldScroll >= p.triggerPoint)) && (p.queueTrigger(r.forward), (i[p.group.id] = p.group));
                            }
                        }
                        return (
            ...
            (function (t) {
                ...
                138: function (t, e, n) {
                    ...
                    t.exports = function (t, e, n, r, s, c) {
                        ...
                        for (c.set(t, e), c.set(e, t); ++f < _; ) {
                            var b = t[f],
                                m = e[f];
                            if (r) var g = l ? r(m, b, f, e, t, c) : r(b, m, f, t, e, c);
                            if (void 0 !== g) {
                                if (g) continue;
                                h = !1;
                                break;
                            ...
                            if (v) {
                                if (
                                    !a(e, function (t, e) {
                                        if (!o(v, e) && (b === t || s(b, t, n, r, c))) return v.push(e);
                                    })
                                ) {
                                    h = !1;
                                    break;
                                }
                            } else if (b !== m && !s(b, m, n, r, c)) {
                                h = !1;
                                break;
                            }
                        }
                ...
                162: function (t, e, n) {
                    ...
                    t.exports = function (t, e) {
                        var n = o(t),
                            ...
                            h = f.length;
                        for (var v in t) (!e && !l.call(t, v)) || (u && ("length" == v || (d && ("offset" == v || "parent" == v)) || (p && ("buffer" == v || "byteLength" == v || "byteOffset" == v)) || s(v, h))) || f.push(v);
                        return f;
                    };
                },
                163: function (t, e) {
                ...
                248: function (t, e, n) {
                    ...
                    t.exports = function (t, e, n, h, v, b) {
                        ...
                        if (k && !x) return b || (b = new i()), m || _(t) ? a(t, e, n, h, v, b) : o(t, e, w, n, h, v, b);
                        if (!(1 & n)) {
                            ...
                            if (j || T) {
                                var O = j ? t.value() : t,
                                    S = T ? e.value() : e;
                                return b || (b = new i()), v(O, S, n, h, b);
                            }
                        }
                        return !!k && (b || (b = new i()), r(t, e, n, h, v, b));
                    };
                },
                249: function (t, e) {
                    t.exports = function (t) {
                ...
                252: function (t, e, n) {
                    ...
                    t.exports = function (t, e, n, o, r, s) {
                        ...
                        for (var v = c; ++d < _; ) {
                            var b = t[(p = l[d])],
                                m = e[p];
                            if (o) var g = c ? o(m, b, p, e, t, s) : o(b, m, p, t, e, s);
                            if (!(void 0 === g ? b === m || r(b, m, n, o, s) : g)) {
                                h = !1;
                                break;
                            }
                            v || (v = "constructor" == p);
            ...
            (function (t) {
                                    ...
                                    (window.et_pb_init_modules = function () {
                                        (n.et_pb_simple_slider = function (t, e) {
                                            var i,
                                                ...
                                                f = "",
                                                h = "",
                                                v = (s.find(".et_pb_container").width(), s.hasClass("et_pb_post_slider")),
                                                b = !1;
                                            if (
                                            ...
                                            function x() {
                                                var t = s,
                                                    ...
                                                    d = et_get_first_section().children(".et_pb_module:visible").first(),
                                                    p = d.find(".et_pb_slide .et_pb_container"),
                                                    u = et_get_first_section().is(".et_pb_fullwidth_section"),
                                        ...
                                        (n.et_pb_simple_carousel = function (t, e) {
                                            ...
                                            (a.et_animation_running = !1),
                                                ...
                                                (a.et_carousel_move_to = function (t) {
                                                    ...
                                                    if ("next" == t) {
                                                        ...
                                                        for (
                                                            var b = 0, m = 0;
                                                            m >= x && m < C && (n(s[b]).addClass("changing_position current_position current_position_".concat(u)), n(s[b]).data("current_position", u), u++),
                                                                m >= h &&
                                                                    m < v &&
                                                                    (n(s[b]).data("next_position", f),
                                                                    n(s[b]).addClass("changing_position next_position next_position_".concat(f)),
                                                                    n(s[b]).hasClass("current_position")
                                                                        ? (n(s[b])
                                                                              .clone(!0)
                                                                              .appendTo(e)
                                                                              .hide()
                                                                              .addClass("delayed_container_append_dup")
                                                                              .attr("id", "".concat(n(s[b]).attr("id"), "-dup")),
                                                                          n(s[b]).addClass("delayed_container_append"))
                                                                        : n(s[b]).addClass("container_append"),
                                                                    f++),
                                                                !(f > c);
                                                            b++, m++
                                                        )
                                            ...
                                            n(function () {
                                                ...
                                                function lt(t) {
                                                    ...
                                                    if (void 0 !== r && !e.data("carouseling"))
                                                        if (
                                                            ...
                                                            for (
                                                                var v = 0, b = 0;
                                                                b >= w && b < y && (n(r[v]).addClass("changing_position current_position current_position_".concat(d)), n(r[v]).data("current_position", d), d++),
                                                                    b >= u &&
                                                                        b < f &&
                                                                        (n(r[v]).data("next_position", p),
                                                                        n(r[v]).addClass("changing_position next_position next_position_".concat(p)),
                                                                        n(r[v]).hasClass("current_position")
                                                                            ? (n(r[v])
                                                                                  .clone(!0)
                                                                                  .appendTo(a)
                                                                                  .hide()
                                                                                  .addClass("delayed_container_append_dup")
                                                                                  .attr("id", "".concat(n(r[v]).attr("id"), "-dup")),
                                                                              n(r[v]).addClass("delayed_container_append"))
                                                                            : n(r[v]).addClass("container_append"),
                                                                        p++),
                                                                    !(p > s);
                                                                v++, b++
                                                            )
                                                    ...
                                                    (window.et_pb_tabs_init = function (t) {
                                                        t.each(function () {
                                                            var t = n(this),
                                                                ...
                                                                i = v || b || m ? 0 : t.find(".et_pb_tab_active").index(),
                                                ...
                                                n(".et_pb_shop, .et_pb_wc_upsells, .et_pb_wc_related_products").each(function () {
                                                    ...
                                                    (window.et_apply_parallax = function () {
                                                        if (n(this).length && void 0 !== n(this) && void 0 !== n(this).offset()) {
                                                            var t = h;
                                                            v ? (t = d.jQuery("#et-fb-app")) : g() && (t = n(window));
                                                            var e = n(this),
                                                                a = e.parent(),
                                                    ...
                                                    (window.et_parallax_set_height = function () {
                                                        var t = n(this),
                                                            ...
                                                            i = 0.3 * h.height() + e;
                                                        b && (i += d.jQuery("#et_pb_layout .inside").offset().top), t.find(".et_parallax_bg").css({ height: "".concat(i, "px") });
                                                    }),
                                                    (window.et_apply_builder_css_parallax = function () {
                                                        if (_.isBuilder || i) {
                                                            var t = n(this),
                                                                e = t.children(".et_parallax_bg");
                                                            if ((e.css({ width: "", height: "", top: "", left: "", backgroundAttachment: "" }), !g() || v)) {
                                                                var a = v ? d.jQuery("#et-fb-app") : h,
                                                                    o = a.scrollTop(),
                                                                    r = b ? d.jQuery("#et_pb_layout .inside").offset().top : 0,
                                                                    s = w() ? 2 : 1,
                                                                    c = t.offset(),
                                                                    p = w() ? c.top / 2 : c.top;
                                                                i &&
                                                ...
                                                var ft = /^[a-zA-Z0-9.!#$%&'*+\/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$/,
                                                    ...
                                                    vt = !_.isBuilder && n(".et_pb_module.et_pb_recaptcha_enabled").length > 0,
                                                    bt = document.body.innerHTML.match(/<script [^>]*src="[^"].*google.com\/recaptcha\/api.js\?render.*"[^>]*>([\s\S]*?)<\/script>/gim),
                                                    mt = n("#et-recaptcha-v3-js"),
                                                    gt = bt && bt.length > mt.length;
                                                function wt(t) {
                                                    var e = t || k;
                                                    e &&
                                                        e.length &&
                                                ...
                                                !_.isBuilder && (gt || (vt && nt && nt.isEnabled())) && n("body").addClass("et_pb_recaptcha_enabled"),
                                                    ht.length &&
                                                        ht.each(function () {
                                                            var t = n(this),
                                                                e = t.find("form"),
                                                                            ...
                                                                            n.when(h).done(function (e) {
                                                                                if (
                                                                                    ...
                                                                                    o.each(function () {
                                                                                        ...
                                                                                        if ("checkbox" === s) {
                                                                                            if (((o = ""), 0 !== e.find('input[type="checkbox"]').length)) {
                                                                                                s = "checkbox";
                                                                                                var b = e.find(".et_pb_checkbox_handle");
                                                                                    ...
                                                                                    var h = parseInt(r.data("first_digit")),
                                                                                        v = parseInt(r.data("second_digit"));
                                                                                    parseInt(r.val()) !== h + v &&
                                                                                        ...
                                                                                        r.data("second_digit", v),
                                                                                        r.val(""),
                                                                                        a.find(".et_pb_contact_captcha_question").empty().append("".concat(h, " + ").concat(v)));
                                                                                }
                                                                                if (!l) {
                                                                                    a.data("submitted", !0);
                                                                                    var b = a.attr("action"),
                                                                                    ...
                                                                                    m.push({ name: "et_pb_contact_email_fields_".concat(c), value: JSON.stringify(p) }),
                                                                                        ...
                                                                                        t
                                                                                            ...
                                                                                            .fadeTo("fast", 0.2, function () {
                                                                                                t.load("".concat(b, " #").concat(t.attr("id"), "> *"), m, function (e, a) {
                                                                                                    if ("error" === a) {
                                                ...
                                                function jt(t) {
                                                    ...
                                                    if (!e.hasClass("et_had_animation")) {
                                                        ...
                                                        for (var f = {}, h = isNaN(parseInt(c)) ? 50 : parseInt(c), v = ["slide", "zoom", "flip", "fold", "roll"], b = !1, m = !1, g = 0; g < v.length; g++) {
                                                            var w = v[g];
                                                            if (i && i.substr(0, w.length) === w) {
                                                                (b = w), "" !== (m = i.substr(w.length, i.length)) && (m = m.toLowerCase());
                                                                break;
                                                            }
                                                        }
                                                        if (
                                                    ...
                                                    (window.et_pb_submit_newsletter = function (t, e) {
                                                        if (t.closest(".et_pb_login_form").length) Pt(t.closest(".et_pb_newsletter"), "con_goal");
                                                            ...
                                                            var a = t.closest(".et_pb_newsletter"),
                                                                ...
                                                                v = a.find(".et_pb_newsletter_success"),
                                                                b = a.data("redirect_url"),
                                                                ...
                                                                if (
                                                                    (C.each(function () {
                                                                        ...
                                                                        if ((a || (a = t.data("original_id")), "radio" === s)) {
                                                                            ...
                                                                            g[a] = v.length > 0 ? v.data("id") : o;
                                                                        } else g[a] = o;
                                                                        if ("mailchimp" === _ && ["select", "radio"].indexOf(s) > -1) {
                                                                            var b = (v = "select" === s ? t.find(":selected") : e.find('input[type="radio"]:checked')).length > 0 ? v.data("id") : null;
                                                                            null !== b && ((g[a] = {}), (g[a][b] = o));
                                                                        }
                                                                                      ...
                                                                                      t.success &&
                                                                                          (b
                                                                                              ? Pt(a, "con_goal", function () {
                                                                                                    ...
                                                                                                    t.length && (b.indexOf("?") > -1 ? (b += "&") : (b += "?")), (window.location = b + t);
                                                                                                })
                                                                                              : (Pt(a, "con_goal"), a.find(".et_pb_newsletter_fields").hide(), v.show())))
                                                ...
                                                (window.et_calc_fullscreen_section = function (t, e) {
                                                    ...
                                                    (Dt[r] = a.width()),
                                                        ...
                                                        (Wt[r] = setTimeout(function () {
                                                            var t = n("body"),
                                                                ...
                                                                k = a.width() < 782,
                                                                j = a.width() > 980,
                                                                T = (a.width() <= 980 && a.width(), a.width(), v + i + g + (window.et_is_vertical_nav && j ? 0 : x)),
                                                    ...
                                                    (window.et_pb_parallax_init = function (t) {
                                                        ...
                                                        t.hasClass("et_pb_parallax_css")
                                                            ...
                                                            : (et_parallax_set_height.bind(e)(),
                                                              ...
                                                              v ? d.jQuery("#et-fb-app").on("scroll.etTrueParallaxBackground", et_apply_parallax.bind(e)) : n(window).on("scroll.etTrueParallaxBackground", et_apply_parallax.bind(e)),
                                                    ...
                                                    (window.et_pb_fullwidth_header_scroll = function (t) {
                                                        ...
                                                        var e = u.width(),
                                                            ...
                                                            v = d.height() === Ft() || !s || !window.et_is_fixed_nav || o || r ? 0 : Ft() - parseFloat(h),
                                                            b = l.top + c.outerHeight(!0) + v - (p + f + Ft());
                                                        if (!m && window.et_is_fixed_nav && o) {
                                                            ...
                                                            (b += Ft() - g.height()), g.remove();
                                                        }
                                                        c.length && n("html, body").animate({ scrollTop: b }, { duration: 800 });
                                                    }),
                                                    window.et_load_event_fired
                                                        ? Nt()
                                                        : n(window).on("load", function () {
                                                            ...
                                                            if (p.is(":visible")) {
                                                                ...
                                                                if (
                                                                    ...
                                                                    if (
                                                                        ...
                                                                        var v = parseInt(s),
                                                                            b = parseInt(d);
                                                                        (("is greater" !== _ && "is less" !== _) || (!isNaN(v) && !isNaN(b))) && (("is greater" === _ && v <= b) || ("is less" === _ && v >= b) || o.push(!0));
                                                                    }
                                                                }
                                                            }
                                                        }
                ...
                1446: function (t, e, n) {
                    ...
                    (function (t) {
                        ...
                        !(function (t) {
                            function e() {
                                return !t("body").hasClass("et_pb_pagebuilder_layout");
                            }
                            function n(e) {
                                var n = t(e.target);
                                        ...
                                        if (!i.hasClass("et_had_animation")) {
                                            ...
                                            for (var f = {}, h = isNaN(parseInt(c)) ? 50 : parseInt(c), v = ["slide", "zoom", "flip", "fold", "roll"], b = !1, m = !1, g = 0; g < v.length; g++) {
                                                ...
                                                if (a && a.substr(0, w.length) === w) {
                                                    (b = w), "" !== (m = a.substr(w.length, a.length)) && (m = m.toLowerCase());
                                                    break;
                                                }
                                            }
                                            if (
                                                (!1 !== b && !1 !== m && (f = this.et_process_animation_intensity(b, m, h)),
                            ...
                            _.init(),
                                ...
                                t(document.body).on("updated_checkout", l),
                                t("#et-boc").on("change", "input.input-radio", l),
                                ...
                                t(document.body).on("init_checkout", function () {
                                    ...
                                    e() ||
                                        ...
                                        (function () {
                                            var e = [],
                                                n = t(".et_pb_wc_checkout_shipping input[name=ship_to_different_address]").is(":checked"),
                                                a = [];
                                            if (
                                                (n &&
                                                    (e.push("shipping_first_name"),
                                                    e.push("shipping_last_name"),
                                                    e.push("shipping_company"),
                                                    e.push("shipping_address_1"),
                                                    e.push("shipping_address_2"),
                                                    e.push("shipping_city"),
                                                    e.push("shipping_postcode")),
                                                (0, i.default)(
                                                ...
                                                (0, i.default)(e, function (e) {
                                                    var n = t(".et_pb_wc_checkout_shipping input[name=".concat(e, "]:not([type=hidden])")).val();
                                                    t("input[type=hidden][name=".concat(e, "]")).remove(), t("<input>").attr({ type: "hidden", value: n, name: e }).prependTo("form.checkout");
                                                }),
                                                n && (a.push("shipping_country"), a.push("shipping_state")),
                                                (0, i.default)(["billing_country", "billing_state"], function (e) {
                                                    var n = t(".et_pb_wc_checkout_billing select[name=".concat(e, "]:visible option:selected")).val();
                                                    t("input[type=hidden][name=".concat(e, "]")).remove(), t("<input>").attr({ type: "hidden", value: n, name: e }).prependTo("form.checkout");
                                                }),
                                                (0, i.default)(a, function (e) {
                                                    var n = t(".et_pb_wc_checkout_shipping select[name=".concat(e, "] option:selected")).val();
                                                    t("input[type=hidden][name=".concat(e, "]")).remove(), t("<input>").attr({ type: "hidden", value: n, name: e }).prependTo("form.checkout");
                                                }),
                                                (0, i.default)(["order_comments"], function (e) {
                                                ...
                                                if (t("input#createaccount:visible").is(":checked")) {
                                                    var o = t("input#createaccount:visible").val();
                                                    t("<input>").attr({ type: "hidden", value: o, name: "createaccount" }).prependTo("form.checkout");
                                                }
                                            } else t("input[type=hidden][name=createaccount]").remove();
                                        })(),
                                        (a = t("form.checkout")),
                                        (c = t(".et_pb_wc_checkout_shipping input[name=ship_to_different_address]").is(":checked")),
                                        a.on("change", "input[type=text][name=billing_first_name]:visible", s),
                                        a.on("change", "input[type=text][name=billing_last_name]:visible", s),
                                        a.on("change", "input[type=text][name=billing_company]:visible", s),
                                        a.on("change", "input[type=text][name=billing_address_1]:visible", s),
                                        a.on("change", "input[type=text][name=billing_address_2]:visible", s),
                                        a.on("change", "input[type=text][name=billing_city]:visible", s),
                                        a.on("change", "input[type=text][name=billing_postcode]:visible", s),
                                        a.on("change", "input[type=tel][name=billing_phone]:visible", s),
                                        a.on("change", "input[type=email][name=billing_email]:visible", s),
                                        a.on("change", "select[name=billing_country]:visible", r),
                                        a.on("change", "select[name=billing_state]:visible", r),
                                        c &&
                                            (a.on("change", "input[type=text][name=shipping_first_name]:visible", s),
                                            a.on("change", "input[type=text][name=shipping_last_name]:visible", s),
                                            a.on("change", "input[type=text][name=shipping_company]:visible", s),
                                            a.on("change", "input[type=text][name=shipping_address_1]:visible", s),
                                            a.on("change", "input[type=text][name=shipping_address_2]:visible", s),
                                            a.on("change", "input[type=text][name=shipping_city]:visible", s),
                                            a.on("change", "input[type=text][name=shipping_postcode]:visible", s),
                                            a.on("change", "select[name=shipping_country]", r),
                                            a.on("change", "select[name=shipping_state]", r)),
                                        a.on("change", "input#createaccount:visible", n),
                                        t("textarea[name=order_comments]").on("change", o),
                                ...
                                t(document.body).on("change", "#ship-to-different-address input", function () {
                                    if (!e()) {
                                        var n = t(this).val(),
                                            a = t(this).attr("name"),
                                            o = t('input[type="hidden"][name='.concat(a, "]"));
                                        ...
                                        o.remove(),
                                            t("<input>").attr({ type: "hidden", value: n, name: a }).prependTo("form.checkout"),
                                            (0, i.default)(["shipping_first_name", "shipping_last_name", "shipping_company", "shipping_address_1", "shipping_address_2", "shipping_city", "shipping_postcode"], function (e) {
                                                var n = t(".et_pb_wc_checkout_shipping input[name=".concat(e, "]:not([type=hidden])")).val();
                                                t("input[type=hidden][name=".concat(e, "]")).remove(), t("<input>").attr({ type: "hidden", value: n, name: e }).prependTo("form.checkout");
                                            }),
                                            (0, i.default)(["shipping_country", "shipping_state"], function (e) {
                                                var n = t(".et_pb_wc_checkout_shipping select[name=".concat(e, "] option:selected")).val();
                                                t("input[type=hidden][name=".concat(e, "]")).remove(), t("<input>").attr({ type: "hidden", value: n, name: e }).prependTo("form.checkout");
                                            });
                                    }
        ...
        !(function (t) {
            ...
            function c(e) {
                var n,
                    ...
                    v = u ? l : _;
                (e = void 0 !== e && e),
                    p && !window.et_is_vertical_nav && (e && (v = l), (n = o * ((v * (s / 100) + 22) / r)), f && (u || e) && (n = 0), !h || u || e || (n = 0), t(".et_header_style_split .centered-inline-logo-wrap").css({ width: n + "px" }));
            }
            function l(e) {
			...
			console.log('here')
                    ...
                    O.length > 0 &&
                        ...
                        (window.et_calculate_header_values = function () {
                            var e = v.length && v.is(":visible") ? parseInt(v.innerHeight()) : 0,
                    ...
                    function W() {
                        var e,
                            n,
                            s = parseInt(o.width()),
                            c = v.length && v.is(":visible") ? parseInt(v.innerHeight()) : 0,
                            l = 0,
                            _ = b.clone().addClass("et-disabled-animations main-header-clone").css({ opacity: "0px", position: "fixed", top: "auto", right: "0px", bottom: "0px", left: "0px" }).appendTo(t("body"));
                        if (
                            ...
                            s > 980 && (!b.attr("data-height-loaded") || t("body").is(".et-fb")))
                        ) {
                            var d = 0;
                            b.hasClass("et-fixed-header") ? (_.removeClass("et-fixed-header"), (d = _.height()), _.addClass("et-fixed-header")) : (d = b.height()), b.attr({ "data-height-onload": parseInt(d), "data-height-loaded": !0 });
                        }
                        if (
                            (s <= 980
                                ? ((e = parseInt(b.length ? b.innerHeight() : 0) + c - (t("body").hasClass("et-fb") ? 0 : 1)), window.et_is_transparent_nav && !i().length && (e += 58))
                                : ((e = parseInt(b.attr("data-height-onload")) + c), window.et_is_transparent_nav && !window.et_is_vertical_nav && r.length && (e += 58), (l = _.height())),
                            u)
                        ) {
                            var p = parseInt(x.data("height")) - parseInt(x.data("fixed-height"));
                            l = parseInt(b.data("height-onload")) - p;
                        }
                        b.attr({ "data-fixed-height-onload": l });
                        ...
                        if (f.length > 0 && "yes" !== f.attr("data-position-set")) {
                            var h = l;
                            0 === h && b.attr("data-height-onload") && (h = b.attr("data-height-onload")), f.css("marginTop", parseFloat(h) + "px"), f.animate({ opacity: "1" }), f.attr("data-position-set", "yes");
                        }
                                    ...
                                    s.waypoint({
                                        ...
                                        handler: function (e) {
                                            if ((c(), "down" === e)) {
                                                ...
                                                if ((b.addClass("et-fixed-header"), m.addClass("et-animated-content"), v.addClass("et-fixed-header"), !u && !window.et_is_transparent_nav && !t(".mobile_menu_bar_toggle").is(":visible"))) {
                                                    var n,
                                                        i,
                                                        a,
                                                        r = v.length ? parseInt(v.height()) : 0;
                                                    (n = b.clone().addClass("et-fixed-header, et_header_clone").css({ transition: "none", display: "none" })),
                                            ...
                                            } else (a = 1), b.removeClass("et-fixed-header"), v.removeClass("et-fixed-header"), m.css("margin-top", -a + "px");
                    ...
                    t(window).on("resize", function () {
                        var n,
                            ...
                            v = f ? e.jQuery("#wpadminbar") : t("#wpadminbar"),
                            g = t("body").hasClass("rtl");
                        (a && p && (q(), j.data("previous-width", d)),
                        u && L(),
                        ((v.length && a && r >= 740 && r <= 782) || f) && (et_calculate_header_values(), H(0)),
                        Z(),
                        h.length &&
                            !t("body").hasClass("et_pb_slide_menu_active") &&
                            (g ? h.css({ left: "-" + parseInt(h.innerWidth()) + "px", right: "unset" }) : h.css({ right: "-" + parseInt(h.innerWidth()) + "px" }),
                            t("body").hasClass("et_boxed_layout") && a && (g ? ((n = m.css("margin-right")), b.css({ right: n })) : ((n = m.css("margin-left")), b.css({ left: n })))),
                        h.length && t("body").hasClass("et_pb_slide_menu_active")) &&
                            (t("body").hasClass("et_boxed_layout")
                                ? ((n = parseFloat(m.css("margin-left"))),
                                  ...
                                  a && (i = 0 > parseInt(h.innerWidth()) - 2 * n ? Math.abs(h.innerWidth() - 2 * n) : "-" + (h.innerWidth() - 2 * n)) < parseInt(h.innerWidth()) && b.css({ left: i + "px" }))
                                : g
                    ...
                    var $,
                        ...
                        Q = function () {
                            ...
                            return (e = f ? n.find(".et-fb-post-content > .et_pb_section") : n.find(".et_builder_inner_content > .et_pb_section")), 0 === i.length || e.length > 1 ? e : i;
                        };
                    function U() {
                            ...
                            if (!0 !== window.et_calculating_scroll_position && !1 !== window.et_side_nav_links_initialized) {
                                ...
                                for (var s = parseInt(t(window).height()), c = parseInt(t(window).scrollTop()), l = s + c === parseInt(t(document).height()), _ = t(".side_nav_item a").length - 1, d = 0; d <= _; d++) {
                                    var p = e.eq(d),
                                        ...
                                        h = null,
                                        v = !1 === u ? p.offset().top - n : 0;
                                    u ? (h = 0) : l ? (h = _) : c >= v && (h = d), null !== h && h !== f && (t(".side_nav_item a").removeClass("active"), t("a#side_nav_item_id_" + h).addClass("active"));
                                }
